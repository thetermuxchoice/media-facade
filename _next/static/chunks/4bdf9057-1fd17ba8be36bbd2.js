    ...
    2248: function (e, t, n) {
          ...
          constructor() {
            super({
              ...
              uniforms: {
                ...
                minLuminance: new i.Uniform(0.01),
      ...
      var a = class extends i.ShaderMaterial {
          ...
          setSize(e, t) {
            ...
            n.texelSize.value.set(1 / e, 1 / t),
              n.halfTexelSize.value.copy(n.texelSize.value).multiplyScalar(0.5);
          }
        },
        ...
        A = class extends i.ShaderMaterial {
            ...
            return (
              (this.fragmentShader =
                "#include <common>\n#include <packing>\n#include <dithering_pars_fragment>\n#define packFloatToRGBA(v) packDepthToRGBA(v)\n#define unpackRGBAToFloat(v) unpackRGBAToDepth(v)\n#ifdef FRAMEBUFFER_PRECISION_HIGH\nuniform mediump sampler2D inputBuffer;\n#else\nuniform lowp sampler2D inputBuffer;\n#endif\n#ifdef GL_FRAGMENT_PRECISION_HIGH\nuniform highp sampler2D depthBuffer;\n#else\nuniform mediump sampler2D depthBuffer;\n#endif\nuniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;\n#if THREE_REVISION >= 137\nvec4 sRGBToLinear(const in vec4 value){return vec4(mix(pow(value.rgb*0.9478672986+vec3(0.0521327014),vec3(2.4)),value.rgb*0.0773993808,vec3(lessThanEqual(value.rgb,vec3(0.04045)))),value.a);}\n#endif\nfloat readDepth(const in vec2 uv){\n#if DEPTH_PACKING == 3201\nreturn unpackRGBAToDepth(texture2D(depthBuffer,uv));\n#else\nreturn texture2D(depthBuffer,uv).r;\n#endif\n}float getViewZ(const in float depth){\n#ifdef PERSPECTIVE_CAMERA\nreturn perspectiveDepthToViewZ(depth,cameraNear,cameraFar);\n#else\nreturn orthographicDepthToViewZ(depth,cameraNear,cameraFar);\n#endif\n}FRAGMENT_HEADvoid main(){FRAGMENT_MAIN_UVvec4 color0=texture2D(inputBuffer,UV);vec4 color1=vec4(0.0);FRAGMENT_MAIN_IMAGEgl_FragColor=color0;\n#ifdef ENCODE_OUTPUT\n#include <encodings_fragment>\n#endif\n#include <dithering_fragment>\n}"
                  .replace(h.FRAGMENT_HEAD, e.get(h.FRAGMENT_HEAD))
                  .replace(h.FRAGMENT_MAIN_UV, e.get(h.FRAGMENT_MAIN_UV))
                  .replace(
                    h.FRAGMENT_MAIN_IMAGE,
                    e.get(h.FRAGMENT_MAIN_IMAGE)
                  )),
              (this.vertexShader =
                "uniform vec2 resolution;uniform vec2 texelSize;uniform float cameraNear;uniform float cameraFar;uniform float aspect;uniform float time;varying vec2 vUv;VERTEX_HEADvoid main(){vUv=position.xy*0.5+0.5;VERTEX_MAIN_SUPPORTgl_Position=vec4(position.xy,1.0,1.0);}"
                  .replace(h.VERTEX_HEAD, e.get(h.VERTEX_HEAD))
                  .replace(
                    h.VERTEX_MAIN_SUPPORT,
                    e.get(h.VERTEX_MAIN_SUPPORT)
                  )),
              (this.needsUpdate = !0),
              this
            );
          ...
          adoptCameraSettings(e) {
            e &&
              ...
              e instanceof i.PerspectiveCamera
      ...
      var m = class {
              ...
              : ((t = new i.Mesh(
                  (function () {
                    if (null === p) {
                      ...
                      void 0 !== (p = new i.BufferGeometry()).setAttribute
                        ? (p.setAttribute(
                            "position",
                            new i.BufferAttribute(e, 3)
                          ),
                          p.setAttribute("uv", new i.BufferAttribute(t, 2)))
                        : (p.addAttribute(
                            "position",
                            new i.BufferAttribute(e, 3)
                          ),
                          p.addAttribute("uv", new i.BufferAttribute(t, 2)));
                    }
                    return p;
                  })(),
                  e
                ...
                (t.frustumCulled = !1),
                null === this.scene && (this.scene = new i.Scene()),
                this.scene.add(t),
                (this.screen = t));
          }
        ...
        w = class extends m {
          ...
          initialize(e, t, n) {
            void 0 !== n &&
              ...
              n !== i.UnsignedByteType
                ? (this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH =
                    "1")
                : e.outputEncoding === i.sRGBEncoding &&
                  (this.renderTarget.texture.encoding = i.sRGBEncoding));
          }
        },
        E = class extends m {
          constructor(
            ...
            super("AdaptiveLuminancePass"),
              (this.fullscreenMaterial = new s()),
              (this.needsSwap = !1),
              (this.renderTargetPrevious = new i.WebGLRenderTarget(1, 1, {
        ...
        C = class extends m {
          ...
          render(e, t, n, i, r) {
            const s = this.overrideClearColor,
              ...
              c = a >= 0;
            l
              ? (B.copy(e.getClearColor(B)), e.setClearColor(s, c ? a : o))
              : c && e.setClearAlpha(a),
              e.setRenderTarget(this.renderToScreen ? null : t),
              e.clear(this.color, this.depth, this.stencil),
              l ? e.setClearColor(B, o) : c && e.setClearAlpha(o);
          }
        },
        x = -1,
        T = class extends i.EventDispatcher {
          constructor(e, t = -1, n = -1, r = 1) {
            super(),
              (this.resizable = e),
              (this.base = new i.Vector2(1, 1)),
              (this.preferred = new i.Vector2(t, n)),
              (this.target = this.preferred),
              (this.s = r);
          }
          get width() {
            const { base: e, preferred: t, scale: n } = this;
            let i;
            return (
              (i =
                t.width !== x
                  ? t.width
                  : t.height !== x
                  ? Math.round(t.height * (e.width / Math.max(e.height, 1)))
                  : Math.round(e.width * n)),
              i
            );
          }
          set width(e) {
        ...
        M = class extends m {
          constructor(e, t, n = null) {
            super("RenderPass", e, t),
              (this.needsSwap = !1),
              (this.clearPass = new C()),
              (this.overrideMaterialManager = null === n ? null : new y(n)),
      ...
      function H(e, t, n, i, r, s, a) {
        const o = new Map([
          ...
          l =
            void 0 !== o.get("fragment") && /mainImage/.test(o.get("fragment")),
        ...
        if (void 0 === o.get("fragment"))
          ...
          if (null !== o.get("vertex") && /mainSupport/.test(o.get("vertex"))) {
            let t = `\t${e}MainSupport(`;
            (t += /mainSupport *\([\w\s]*?uv\s*?\)/.test(o.get("vertex"))
              ? "vUv);\n"
              : ");\n"),
              n.set(v.VERTEX_MAIN_SUPPORT, n.get(v.VERTEX_MAIN_SUPPORT) + t),
              (u = u.concat(
              ...
              (d = d
                .concat(u)
                .concat([...o.get("vertex").matchAll(f)].map((e) => e[1])));
          }
          (d = d.concat([...o.get("fragment").matchAll(f)].map((e) => e[1]))),
            (d = d.concat(
              [...t.defines.keys()].map((e) => e.replace(/\([\w\s,]*\)/g, ""))
            )),
            (d = d.concat([...t.uniforms.keys()])),
            t.uniforms.forEach((t, n) =>
              s.set(e + n.charAt(0).toUpperCase() + n.slice(1), t)
            ),
            t.defines.forEach((t, n) =>
              r.set(e + n.charAt(0).toUpperCase() + n.slice(1), t)
            ),
            G(e, d, r),
            G(e, d, o);
          const p = t.blendMode;
          if ((i.set(p.blendFunction, p), l)) {
            ...
            0 !== (a & b) &&
              t.test(o.get("fragment")) &&
              ((i += "depth, "), (g = !0)),
              (i += "color1);\n\t");
            const r = e + "BlendOpacity";
            s.set(r, p.opacity),
              (i += `color0 = blend${p.blendFunction}(color0, color1, ${r});\n\n\t`),
              n.set(v.FRAGMENT_MAIN_IMAGE, n.get(v.FRAGMENT_MAIN_IMAGE) + i),
              (i = `uniform float ${r};\n\n`),
              n.set(v.FRAGMENT_HEAD, n.get(v.FRAGMENT_HEAD) + i);
          }
          n.set(
            v.FRAGMENT_HEAD,
            n.get(v.FRAGMENT_HEAD) + o.get("fragment") + "\n"
          ),
            null !== o.get("vertex") &&
              n.set(
                v.VERTEX_HEAD,
                n.get(v.VERTEX_HEAD) + o.get("vertex") + "\n"
              );
        } else
          console.error(
        ...
        return { varyings: u, transformedUv: h, readDepth: g };
      }
      var N = class extends m {
          constructor(e, ...t) {
            super("EffectPass"),
              (this.fullscreenMaterial = new A(null, null, null, e)),
          ...
          updateMaterial() {
            ...
            for (const h of this.effects)
              if (h.blendMode.blendFunction === R.SKIP)
                l |= h.getAttributes() & b;
              else if (0 !== (l & h.getAttributes() & O))
                console.error("Convolution effects cannot be merged", h);
              else {
                l |= h.getAttributes();
            ...
            if (c) {
              ...
              t.set(e.FRAGMENT_MAIN_UV, n + t.get(e.FRAGMENT_MAIN_UV)),
                i.set("UV", "transformedUv");
            } else i.set("UV", "vUv");
          ...
          initialize(e, t, n) {
            ...
            for (const i of this.effects)
              i.initialize(e, t, n),
                i.addEventListener("change", (e) => this.handleEvent(e));
            this.updateMaterial(),
        ...
        z = class extends m {
          constructor({
            ...
            super("KawaseBlurPass"),
              (this.renderTargetA = new i.WebGLRenderTarget(1, 1, {
                minFilter: i.LinearFilter,
                magFilter: i.LinearFilter,
                stencilBuffer: !1,
                depthBuffer: !1,
            ...
            s.addEventListener("change", (e) =>
              ...
              (this.blurMaterial = new a()),
              (this.ditheredBlurMaterial = new a()),
          ...
          render(e, t, n, i, r) {
            ...
            let u,
              ...
              A = t;
            for (
              this.fullscreenMaterial = h, u = 0, d = c.length - 1;
              u < d;
              ++u
            ) {
              const t = 0 === (1 & u) ? o : l;
              (h.kernel = c[u]),
                (h.inputBuffer = A.texture),
                e.setRenderTarget(t),
                e.render(s, a),
                (A = t);
            }
            this.dithering &&
              ((h = this.ditheredBlurMaterial), (this.fullscreenMaterial = h)),
              (h.kernel = c[u]),
              (h.inputBuffer = A.texture),
              e.setRenderTarget(this.renderToScreen ? null : n),
              e.render(s, a);
              ...
              n !== i.UnsignedByteType
                ? ((this.blurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH = "1"),
                  (this.ditheredBlurMaterial.defines.FRAMEBUFFER_PRECISION_HIGH =
                    "1"))
                : e.outputEncoding === i.sRGBEncoding &&
                  ((this.renderTargetA.texture.encoding = i.sRGBEncoding),
                  (this.renderTargetB.texture.encoding = i.sRGBEncoding)));
          }
          static get AUTO_SIZE() {
            return T.AUTO_SIZE;
          }
        ...
        k = class extends m {
          constructor({
            ...
            super("LuminancePass"),
              (this.fullscreenMaterial = new g(s, r)),
              (this.needsSwap = !1),
              (this.renderTarget = n),
        ...
        V = class extends m {
          constructor(
            ...
            super("NormalPass"),
              (this.needsSwap = !1),
              (this.renderPass = new M(e, t, new i.MeshNormalMaterial()));
            const o = this.renderPass;
            o.setBackgroundDisabled(!0), o.setShadowMapDisabled(!0);
            const l = o.getClearPass();
            l.setOverrideClearColor(new i.Color(7829503)),
              l.setOverrideClearAlpha(1),
              (this.renderTarget = a),
              void 0 === this.renderTarget &&
                ((this.renderTarget = new i.WebGLRenderTarget(1, 1, {
                  minFilter: i.NearestFilter,
        ...
        K = class {
          ...
          setRenderer(e) {
            if (((this.renderer = e), null !== e)) {
              ...
              r === i.UnsignedByteType &&
                e.outputEncoding === i.sRGBEncoding &&
                ((this.inputBuffer.texture.encoding = i.sRGBEncoding),
                (this.outputBuffer.texture.encoding = i.sRGBEncoding),
                this.inputBuffer.dispose(),
                this.outputBuffer.dispose()),
                (e.autoClear = !1),
          ...
          createDepthTexture() {
            ...
            return (
              ...
              this.inputBuffer.stencilBuffer
                ? ((e.format = i.DepthStencilFormat),
                  (e.type = i.UnsignedInt248Type))
                : (e.type = i.UnsignedIntType),
              e
            );
          }
          deleteDepthTexture() {
          ...
          createBuffer(e, t, n, r) {
            const s = this.renderer,
              a =
                null === s
                  ? new i.Vector2()
                  : s.getDrawingBufferSize(new i.Vector2()),
              o = {
                minFilter: i.LinearFilter,
                magFilter: i.LinearFilter,
                stencilBuffer: t,
            ...
            return (
              r > 0
                ? ((l =
                    Number(i.REVISION.replace(/\D+/g, "")) < 138
                      ? new i.WebGLMultisampleRenderTarget(a.width, a.height, o)
                      : new i.WebGLRenderTarget(a.width, a.height, o)),
                  (l.ignoreDepthForMultisampleCopy = !1),
                  (l.samples = r))
                : (l = new i.WebGLRenderTarget(a.width, a.height, o)),
              n === i.UnsignedByteType &&
                null !== s &&
                s.outputEncoding === i.sRGBEncoding &&
                (l.texture.encoding = i.sRGBEncoding),
          ...
          render(e) {
            ...
            for (const c of this.passes)
              c.enabled &&
                ...
                c.needsSwap &&
                  (l &&
                    ((n.renderToScreen = c.renderToScreen),
                    (i = t.getContext()),
                  ...
                  (a = o),
                  (o = s)),
                c instanceof Y ? (l = !0) : c instanceof D && (l = !1));
          }
          setSize(e, t, n) {
          ...
          class extends U {
            constructor({
              ...
              super(
                ...
                (this.luminancePass = new k({
                  renderTarget: this.renderTarget,
                  colorOutput: !0,
                })),
                (this.luminanceMaterial.threshold = t),
                (this.luminanceMaterial.smoothingFactor = n),
                (this.blurPass = new z({
                  resolutionScale: r,
                  width: a,
                  height: o,
            ...
            update(e, t, n) {
              ...
              this.luminancePass.enabled
                ? (this.luminancePass.render(e, t, i),
                  this.blurPass.render(e, i, i))
            ...
            setSize(e, t) {
              ...
              n.setBaseSize(e, t),
                ...
                this.luminancePass.resolution.copy(n);
            }
            initialize(e, t, n) {
        ...
        q = class extends U {
          constructor({ blendFunction: e = R.NORMAL, bits: t = 16 } = {}) {
            super(
              "ColorDepthEffect",
              ...
              {
                blendFunction: e,
                uniforms: new Map([["factor", new i.Uniform(1)]]),
              }
            ),
              (this.bits = 0),
              (this.bitDepth = t);
        ...
        _ = class extends U {
          constructor({ blendFunction: e = R.NORMAL, inverted: t = !1 } = {}) {
            super(
              "DepthEffect",
              "void mainImage(const in vec4 inputColor,const in vec2 uv,const in float depth,out vec4 outputColor){\n#ifdef INVERTED\nvec3 color=vec3(1.0-depth);\n#else\nvec3 color=vec3(depth);\n#endif\noutputColor=vec4(color,inputColor.a);}",
              { blendFunction: e, attributes: b }
            ),
              (this.inverted = t);
          }
          get inverted() {
      ...
      var ne = class {
          ...
          toCanvas() {
            return "undefined" === typeof document
              ? null
              : te(this.width, this.height, this.data);
          }
          static from(e) {
        ...
        se = class extends i.DataTexture3D {
          constructor(e, t) {
            super(e, t, t, t),
              ...
              (this.format = i.RGBAFormat),
              (this.encoding = i.LinearEncoding),
              (this.minFilter = i.LinearFilter),
              (this.magFilter = i.LinearFilter),
              (this.wrapS = i.ClampToEdgeWrapping),
              (this.wrapT = i.ClampToEdgeWrapping),
              (this.wrapR = i.ClampToEdgeWrapping),
              (this.unpackAlignment = 1),
              (this.needsUpdate = !0),
              (this.domainMin = new i.Vector3(0, 0, 0)),
              (this.domainMax = new i.Vector3(1, 1, 1));
          }
                ...
                e <= n.width
                  ...
                  : new Promise((i, r) => {
                      const s = URL.createObjectURL(
                        ...
                        a = new Worker(s);
                      a.addEventListener("error", (e) => r(e.error)),
                      ...
                      a.postMessage(
                        { operation: ie, data: n.data, size: e },
                        o
                      );
                    })),
              i
          ...
          applyLUT(e) {
            ...
            if (r !== Math.min(n.width, n.height, n.depth))
              console.error("Size mismatch");
            else if (e.type !== i.FloatType || this.type !== i.FloatType)
              console.error("Both LUTs must be FloatType textures");
            else if (e.format !== i.RGBAFormat || this.format !== i.RGBAFormat)
          ...
          convertToUint8() {
            if (this.type === i.FloatType) {
              ...
              for (let n = 0, i = e.length; n < i; ++n) t[n] = 255 * e[n] + 0.5;
              (this.image.data = t),
                (this.type = i.UnsignedByteType),
                (this.needsUpdate = !0);
            }
            return this;
          }
          ...
          convertLinearToSRGB() {
            ...
            if (this.type === i.FloatType) {
              for (let t = 0, n = e.length; t < n; t += 4)
                re.fromArray(e, t).convertLinearToSRGB().toArray(e, t);
          ...
          convertSRGBToLinear() {
            ...
            if (this.type === i.FloatType) {
              for (let t = 0, n = e.length; t < n; t += 4)
                re.fromArray(e, t).convertSRGBToLinear().toArray(e, t);
          ...
          toDataTexture() {
            ...
            return (
              ...
              (n.encoding = this.encoding),
              (n.minFilter = i.LinearFilter),
              (n.magFilter = i.LinearFilter),
              (n.wrapS = this.wrapS),
              (n.wrapT = this.wrapT),
              (n.generateMipmaps = !1),
              (n.needsUpdate = !0),
          ...
          static from(e) {
            ...
            const a = new se(s, r);
            return (
              (a.encoding = e.encoding), (a.type = e.type), (a.name = e.name), a
            );
          }
        ...
        ae = class extends U {
          constructor(
            ...
            super(
              ...
              (this.inputEncoding = i.sRGBEncoding),
              (this.lut = e);
          }
          getOutputEncoding() {
          ...
          set lut(e) {
            ...
            if (this.lut !== e && ((n.get("lut").value = e), null !== e)) {
              ...
              if (
                (t.clear(),
                t.set("LUT_SIZE", Math.min(r.width, r.height).toFixed(16)),
                t.set("LUT_TEXEL_WIDTH", (1 / r.width).toFixed(16)),
                t.set("LUT_TEXEL_HEIGHT", (1 / r.height).toFixed(16)),
                (n.get("domainMin").value = null),
                (n.get("domainMax").value = null),
                (e.type !== i.FloatType && e.type !== i.HalfFloatType) ||
                  t.set("LUT_PRECISION_HIGH", "1"),
                r.width > r.height
                  ? t.set("LUT_STRIP_HORIZONTAL", "1")
                  : e instanceof i.DataTexture3D && t.set("LUT_3D", "1"),
                e instanceof se)
              ) {
                const i = e.domainMin,
                  r = e.domainMax;
                (0 === i.x &&
                  ...
                  1 === r.y &&
                  1 === r.z) ||
                  (t.set("CUSTOM_INPUT_DOMAIN", "1"),
                  (n.get("domainMin").value = i.clone()),
                  (n.get("domainMax").value = r.clone()));
              }
            ...
            if (null !== e) {
              ...
              if (this.tetrahedralInterpolation && e instanceof i.DataTexture3D)
                if (this.defines.has("CUSTOM_INPUT_DOMAIN")) {
                  ...
                  n.setScalar(t - 1).divide(i),
                    r.copy(e.domainMin).negate().multiply(n);
          ...
          configureTetrahedralInterpolation() {
            ...
            null !== e &&
              ...
              this.tetrahedralInterpolation &&
                (e instanceof i.DataTexture3D
                  ? ((e.minFilter = i.NearestFilter),
                    (e.magFilter = i.NearestFilter))
                  : console.warn(
                      "Tetrahedral interpolation requires a 3D texture"
                    )),
              void 0 === e.source && (e.needsUpdate = !0));
          }
        ...
        he = class extends U {
            ...
            super(
              ...
              "uniform bool active;uniform vec2 center;uniform float waveSize;uniform float radius;uniform float maxRadius;uniform float amplitude;varying float vSize;void mainUv(inout vec2 uv){if(active){vec2 aspectCorrection=vec2(aspect,1.0);vec2 difference=uv*aspectCorrection-center*aspectCorrection;float distance=sqrt(dot(difference,difference))*vSize;if(distance>radius){if(distance<radius+waveSize){float angle=(distance-radius)*PI2/waveSize;float cosSin=(1.0-cos(angle))*0.5;float extent=maxRadius+waveSize;float decay=max(extent-distance*distance,0.0)/extent;uv-=((cosSin*amplitude*difference)/distance)*decay;}}}}",
              {
                ...
                uniforms: new Map([
                  ...
                  ["center", new i.Uniform(new i.Vector2(0.5, 0.5))],
          ...
          update(e, t, n) {
            ...
            if (this.active) {
              ...
              r.getWorldDirection(ue),
                de.copy(r.position).sub(i),
                (a.value = ue.angleTo(de) > ce),
                a.value &&
                  ((s.get("cameraDistance").value = r.position.distanceTo(i)),
                  ue.copy(i).project(r),
                  this.screenPosition.set(0.5 * (ue.x + 1), 0.5 * (ue.y + 1))),
                (this.time += n * this.speed);
              const t = this.time - e;
              (s.get("radius").value = t),
                t >= 2 * (s.get("maxRadius").value + e) &&
                  ((this.active = !1), (a.value = !1));
            }
          }
        },
        Ae = class extends U {
          constructor({ blendFunction: e = R.NORMAL, intensity: t = 1 } = {}) {
            super(
              "SepiaEffect",
              ...
              {
                blendFunction: e,
                uniforms: new Map([["intensity", new i.Uniform(t)]]),
              }
            );
          }
          get intensity() {
        ...
        ve = { LOW: 0, MEDIUM: 1, HIGH: 2, ULTRA: 3 },
        pe = class extends U {
          constructor({
            preset: e = ve.MEDIUM,
            ...
            super(
              ...
              "uniform sampler2D weightMap;varying vec2 vOffset0;varying vec2 vOffset1;void movec(const in bvec2 c,inout vec2 variable,const in vec2 value){if(c.x){variable.x=value.x;}if(c.y){variable.y=value.y;}}void movec(const in bvec4 c,inout vec4 variable,const in vec4 value){movec(c.xy,variable.xy,value.xy);movec(c.zw,variable.zw,value.zw);}void mainImage(const in vec4 inputColor,const in vec2 uv,out vec4 outputColor){vec4 a;a.x=texture2D(weightMap,vOffset0).a;a.y=texture2D(weightMap,vOffset1).g;a.wz=texture2D(weightMap,uv).rb;vec4 color=inputColor;if(dot(a,vec4(1.0))>=1e-5){bool h=max(a.x,a.z)>max(a.y,a.w);vec4 blendingOffset=vec4(0.0,a.y,0.0,a.w);vec2 blendingWeight=a.yw;movec(bvec4(h),blendingOffset,vec4(a.x,0.0,a.z,0.0));movec(bvec2(h),blendingWeight,a.xz);blendingWeight/=dot(blendingWeight,vec2(1.0));vec4 blendingCoord=blendingOffset*vec4(texelSize,-texelSize)+uv.xyxy;color=blendingWeight.x*texture2D(inputBuffer,blendingCoord.xy);color+=blendingWeight.y*texture2D(inputBuffer,blendingCoord.zw);}outputColor=color;}",
              {
                ...
                attributes: O | b,
                uniforms: new Map([["weightMap", new i.Uniform(null)]]),
              }
            ),
              arguments.length > 1 &&
                ((r = arguments[0]),
              ...
              (this.renderTargetEdges = new i.WebGLRenderTarget(1, 1, {
                minFilter: i.LinearFilter,
                stencilBuffer: !1,
                depthBuffer: !1,
              })),
              ...
              (this.clearPass = new C(!0, !1, !1)),
              (this.clearPass.overrideClearColor = new i.Color(0)),
              (this.clearPass.overrideClearAlpha = 1),
              (this.edgeDetectionPass = new X(new d())),
              (this.edgeDetectionMaterial.edgeDetectionMode = t),
              (this.edgeDetectionMaterial.predicationMode = n),
              (this.weightsPass = new X(new f()));
        ...
        Ce = class extends U {
          ...
          set mode(e) {
            if (this.mode !== e) {
              ...
              (this.adaptiveLuminancePass.enabled = e === Ee),
                this.setChanged();
            }
          }
          getMode() {
      ...
      var Se = class extends i.Loader {
          load(e, t = () => {}, n = () => {}, r = null) {
            ...
            return (
              o.setPath(this.path),
              o.setResponseType("text"),
              new Promise((i, l) => {
                (a.onError = (e) => {
                  s.itemError(e),
                    null !== r
                      ? (r(`Failed to load ${e}`), i())
                      : l(`Failed to load ${e}`);
                }),
                  s.itemStart(e),
                  o.load(
          ...
          parse(e) {
            ...
            if (((n = /LUT_3D_SIZE +(\d+)/.exec(e)), null === n))
            ...
            if (
              ((n = /DOMAIN_MIN +([\d.]+) +([\d.]+) +([\d.]+)/.exec(e)),
              null !== n && o.set(Number(n[1]), Number(n[2]), Number(n[3])),
              (n = /DOMAIN_MAX +([\d.]+) +([\d.]+) +([\d.]+)/.exec(e)),
              null !== n && l.set(Number(n[1]), Number(n[2]), Number(n[3])),
              o.x > l.x || o.y > l.y || o.z > l.z)
            )
              throw (
                (o.set(0, 0, 0),
                l.set(1, 1, 1),
